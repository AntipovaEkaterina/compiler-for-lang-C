...
void StatemenList(struct AST* StetementNode)
{
        ...
        strcmp(parser->knots->token, "return") == 0)
    {
        ...
        if (strcmp(parser->knots->token, "comma") == 0 || 
        strcmp(parser->knots->token, "d_equally") == 0 || 
        ...
        strcmp(parser->knots->token, "l_paren") == 0 ||
        strcmp(parser->knots->token, "r_paren") == 0 ||
        strcmp(parser->knots->token, "l_square") == 0 ||
        strcmp(parser->knots->token, "r_square") == 0 ||
        strcmp(parser->knots->token, "equally") == 0 ||
        strcmp(parser->knots->token, "semicolon") == 0 || 
...
void Scanf(struct AST* StetementNode)
{
    ...
    Set_Token(LiteralNode,  parser->knots);
...
void Ident(struct AST* AnnouncementNode)
{
    if (strcmp(parser->knots->token, "l_square") == 0)
    {
       ...
       // Set_Token(getLastNode,  parser->knots);
        //Set_Line(IdNode, "arv");
        eating("l_square");
